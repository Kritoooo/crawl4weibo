...
class TestSearchPostsByCount:
    ...
    @responses.activate
    def test_search_posts_by_count_stops_at_last_page(self):
        ...
        client = WeiboClient()
        posts = client.search_posts_by_count("Python", count=100)
...
class TestSearchAllPosts:
    ...
    @responses.activate
    def test_search_all_posts_fetches_until_last_page(self):
        ...
        client = WeiboClient()
        posts = client.search_all_posts("Python")
    ...
    @responses.activate
    def test_search_all_posts_respects_max_pages(self):
        ...
        client = WeiboClient()
        posts = client.search_all_posts("Python", max_pages=2)
    ...
    @responses.activate
    def test_search_all_posts_handles_empty_results(self):
        ...
        client = WeiboClient()
        posts = client.search_all_posts("NonExistentTopic")
